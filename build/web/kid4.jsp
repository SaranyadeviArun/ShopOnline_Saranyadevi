<%-- 
    Document   : kid4
    Created on : Oct 17, 2018, 8:57:24 PM
    Author     : peter
--%>
...
%>
    <body style="background-color:whitesmoke">
        ...
        <form action="CartServlet" method="post">
          ...
          <table>
              <tr>
                <td><img src="Images\teddy.jpg" width="300" height="350">
</td>
    <td><h2>AVS Stuffed Spongy Huggable Cute Teddy Bear 
</h2><p><b>Rs.1,200</b></p><h4><b> Highlights</b></h4><ul>
    <li>Teddy Bears</li>
    <li>Character: Teddies</li>
    <li>Skillset: Social Skills</li>
<li>Washable</li>
</ul>
...
String sql ="SELECT productname,mrp FROM product where pid='kid4'";
resultSet = statement.executeQuery(sql);
while(resultSet.next()){
%>
<tr><td align="center"><br><br><br><br>
          
          <input type="hidden" value="kid4" name="pid">
