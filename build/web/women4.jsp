<%-- 
    Document   : women4
    Created on : Oct 17, 2018, 12:18:53 PM
    Author     : peter
--%>
...
%>
    <body>
        ...
        <form action="CartServlet" method="post">
          ...
          <table>
              <tr>
                <td><img src="Images\bracelet.jpg" width="400" height="300"></td>
                <td><h2>White stone fashioned bracelet

</h2><p><b>Rs.375</b></p><h4><b> Highlights</b></h4><ul>
...
String sql ="SELECT productname,mrp FROM product where pid='women4'";
resultSet = statement.executeQuery(sql);
while(resultSet.next()){
%>
<tr><td align="center">
          
          <input type="hidden" value="women4" name="pid">
