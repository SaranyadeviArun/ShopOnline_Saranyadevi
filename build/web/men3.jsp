<%-- 
    Document   : men3
    Created on : Oct 17, 2018, 1:05:14 PM
    Author     : peter
--%>
...
%>
    <body style="background-color:whitesmoke">
        ...
        <form action="CartServlet" method="post">
          ...
          <table>
              <tr>
                <td><img src="Images\menshoe.jpg" width="300" height="300">
</div></td>
    <td><h2>Sneakers For Men  (Blue)</h2><p><b>Rs.499</b></p><h4><b> Highlights</b></h4><ul>
            <li>Colour: Blue</li>
            <li>3 inch Heel Height</li>
<li>Outer Material: Canvas</li></ul>
...
String sql ="SELECT productname,mrp FROM product where pid='men3'";
resultSet = statement.executeQuery(sql);
while(resultSet.next()){
%>
<tr><td align="center">
          
          <input type="hidden" value="men3" name="pid">
