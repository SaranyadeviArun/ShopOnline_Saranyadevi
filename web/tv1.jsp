<%-- 
    Document   : tv1
    Created on : Oct 16, 2018, 10:07:18 AM
    Author     : peter
--%>
...
%>
    <body style="background-color:whitesmoke">
        ...
        <form action="CartServlet" method="post">
          ...
          <table>
              <tr>
                <td><img src="Images\treetvpage.jpg" width="400" height="300"></td>
                <td><h2>Samsung Full HD LED TV (Black) TV</h2>
                    <p><b>Rs.37,490</b></p><h4><b> Highlights</b></h4><ul><li>20 W Speaker Output</li>
...
<tr><td align="center">
          ...
          <input type="hidden" value="tv1" name="pid">
