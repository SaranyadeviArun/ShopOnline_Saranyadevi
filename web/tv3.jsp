<%-- 
    Document   : tv3
    Created on : Oct 15, 2018, 3:59:18 PM
    Author     : peter
--%>
...
%>
    <body>
        ...
        <form action="CartServlet" method="post">
          ...
          <table>
              <tr>
                <td><img src="Images\cycletvpage.jpg" width="400" height="300"></td>
                <td><h2>TCL 109.3 cm (43 inches) L43P2US 4K UHD LED Smart TV </h2>
                    <p><b>Rs.40,099</b></p><h4><b> Highlights</b></h4><ul><li>20 W Speaker Output</li>
...
String sql ="SELECT productname,mrp FROM product where pid='tv3'";
resultSet = statement.executeQuery(sql);
while(resultSet.next()){
%>
<tr><td align="center">
          
          <input type="hidden" value="tv3" name="pid">
